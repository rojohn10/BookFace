    ...
    class PostAdapter : RecyclerView.Adapter
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            itemView = LayoutInflater.From(parent.Context)
                                     .Inflate(Resource.Layout.post, parent, false);

            var vh = new PostAdapterViewHolder(itemView, OnClick, OnLongClick, OnLikeClick);
            return vh;
        }
        ...
        void OnLikeClick(PostAdapterClickEventArgs args) => LikeClick?.Invoke(this, args);
